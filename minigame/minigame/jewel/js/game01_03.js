...
function gameFinish(){
	...
	document.addEventListener('DOMContentLoaded', () => {
		...
		const answers = {
			...
			stage03: 'can i make the phone',
			stage04: 'can i eat the phone',
			stage05: 'can i touch the phone',
			stage06: 'can i use the phone',
		};
		...
		document.querySelectorAll('.btn-complete').forEach(button => {
			button.addEventListener('click', () => {
				...
				if (userAnswer.toLowerCase() === correctAnswer.toLowerCase()) {
					...
					console.log('현재 틀린 문제 개수:' + wrongCount);
